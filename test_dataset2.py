...
# Load dataset2
dataset = datasets.ImageFolder(root='Datasets/dataset2', transform=transforms.ToTensor())
...
dataset = datasets.ImageFolder(root='Datasets/dataset2', transform=transform)
...
plt.savefig("Metrics/dataset2 - Confusion Matrix.png")
...
for i in range(number_of_visualisations):
    ...
    plt.savefig("Metrics/dataset2 - GradCamPP Correct.png")
...
for i in range(number_of_visualisations):
    ...
    plt.savefig("Metrics/dataset2 - GradCamPP Incorrect.png")
...
plt.savefig("Metrics/dataset2 - LIME Correct.png", bbox_inches='tight')
...
# Save the plot to a file
plt.savefig("Metrics/dataset2 - LIME Incorrect.png", bbox_inches='tight')
...
plt.savefig("Metrics/dataset2 - SHAP Correct.png", bbox_inches='tight')
...
# Save the full figure with all subplots
plt.savefig("Metrics/dataset2 - SHAP Incorrect.png", bbox_inches='tight')
